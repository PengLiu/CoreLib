...
@ActiveProfiles("oracle_test")
public class PluginOracleTest {
	...
	@Test
	public void oracleImportTest() throws InterruptedException, ExecutionException {
		PluginConfig readerConfig = new PluginConfig();
		readerConfig.put("url", oracleUrl);
		readerConfig.put("driver", "oracle.jdbc.driver.OracleDriver");
		readerConfig.put("table", "INST_POJO");
		readerConfig.put("username", oracleUserName);
		readerConfig.put("password", oraclePassword);
